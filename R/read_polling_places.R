...
#' created by the original data producer and the coordinates found via geocoding
...
#' coordinates of `c(-1, -1)` to a all polling places located outside of Brazil.
#' When the coordinates from the original source are
